...
# -------------------------------------------------------
# Works both locally/on Streamlit Cloud (results/ committed next to this
# file) and, as a fallback, in a Colab session with Drive mounted.
_APP_DIR = os.path.dirname(os.path.abspath(__file__))
_LOCAL_RESULTS = os.path.join(_APP_DIR, "results")
_DRIVE_RESULTS = "/content/drive/MyDrive/CCS4354_Tensors_and_Graphs/results"

if os.path.isdir(_LOCAL_RESULTS):
    BASE_DIR = _LOCAL_RESULTS
elif os.path.isdir(_DRIVE_RESULTS):
    BASE_DIR = _DRIVE_RESULTS
else:
    BASE_DIR = _LOCAL_RESULTS  # default; image/CSV checks below will just warn if missing
